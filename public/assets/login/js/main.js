  ...
  var dialia = {
    ...
    sliderActivations: {
      ...
      productSliderActivation: function () {
        $('.product-slider-active').slick({
          ...
          arrows: true,
          prevArrow:
            '<button class="tm-slider-arrow-prev"><i class="zmdi zmdi-arrow-left"></i></button>',
          nextArrow:
            '<button class="tm-slider-arrow-next"><i class="zmdi zmdi-arrow-right"></i></button>',
          dots: false,
          responsive: [
            {
              breakpoint: 992,
    ...
    fancyboxActive: function () {
      $('[data-fancybox]').fancybox({
        beforeShow: function () {
          $('.tm-product-quickview .tm-prodetails-largeimages').slick(
            'slickNext',
          );
        },
      });
