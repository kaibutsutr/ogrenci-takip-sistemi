 ...
 * %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 *
 * Template Name: Dialia - Registered Massage Therapy web sitesi
 * Template URI: https://thememarch.com/demo/html/dialia/
 * Description: Dialia is a registered massage therapy web sitesi which comes with the unique and clean design. It helps you to create a beautiful massage therapy HTML website. It's a fully responsive website template. It has also e-commerce support. E-commerce pages are included on this template.
 * Author: Thememarch
            ...
            if (i) {
              ...
              for (var c = 0; c < i.length; c += 1) {
                ...
                if (!(g.length < 2)) {
                  ...
                  h.height = "auto";
                  var p = h.maxHeight;
                  if (((h.maxHeight = "none"), f.offsetHeight <= t))
                    (h.height = u), (h.maxHeight = p);
                  else {
                    for (var y = g.length - 1, j = 0, m = void 0; j < y; )
                      (m = (j + y + 1) >> 1),
                        (f[d] = s ? g.slice(0, m).join(" ") : g.slice(0, m)),
                        f.insertAdjacentHTML("beforeend", r),
                        f.offsetHeight > t ? (y = s ? m - 1 : m - 2) : (j = m);
                    (f[d] = s ? g.slice(0, y).join(" ") : g.slice(0, y)),
                      f.insertAdjacentHTML("beforeend", r);
...
!(function (e, t) {
  ...
  function $(a, s) {
    for (
      var e = arguments.length, n = new Array(2 < e ? e - 2 : 0), t = 2;
      t < e;
      t++
    )
      n[t - 2] = arguments[t];
  ...
  var V = /\d+/g,
    Y = {
      show: function () {
        this.built || this.build(),
          this.shown ||
            this.trigger(u).isDefaultPrevented() ||
            ((this.shown = !0),
            this.$picker.removeClass(p).on(r, D.proxy(this.click, this)),
            this.showView(this.options.startView),
            this.inline ||
              (this.$scrollParent.on(i, D.proxy(this.place, this)),
              D(window).on(t, (this.onResize = $(this.place, this))),
              D(document).on(
                r,
                (this.onGlobalClick = $(this.globalClick, this))
              ),
              D(document).on(
                l,
                (this.onGlobalKeyup = $(this.globalKeyup, this))
              ),
              this.place()));
      },
      hide: function () {
        this.shown &&
          (this.trigger(o).isDefaultPrevented() ||
            ((this.shown = !1),
            this.$picker.addClass(p).off(r, this.click),
            this.inline ||
              (this.$scrollParent.off(i, this.place),
              D(window).off(t, this.onResize),
      ...
      pick: function (e) {
        var t = this.$element,
          i = this.date;
        this.trigger(c, { view: e || "", date: i }).isDefaultPrevented() ||
      ...
      getMonthName: function (e, t) {
        var i = this.options,
          ...
          s = i.months;
        return (
          D.isNumeric(e) ? (e = Number(e)) : b(t) && (t = e),
          !0 === t && (s = a),
          s[k(e) ? e : this.date.getMonth()]
        );
      },
      getDayName: function (e, t, i) {
        var a = this.options,
          s = a.days;
        return (
          D.isNumeric(e) ? (e = Number(e)) : (b(i) && (i = t), b(t) && (t = e)),
          i ? (s = a.daysMin) : t && (s = a.daysShort),
          s[k(e) ? e : this.date.getDay()]
        );
      },
      getDate: function (e) {
        var t = this.date;
      ...
      setDate: function (e, t) {
        ...
        if (C(e) || m(e)) {
          if (
            ((e = this.parseDate(e)),
            D.isFunction(i) && !1 === i.call(this.$element, e, "day"))
          )
            return;
          (this.date = e),
    ...
    I = {
      click: function (e) {
        ...
        if (
          ...
          switch (n) {
            case "years prev":
            case "years next":
              (r = "years prev" === n ? r - 10 : r + 10),
                (this.viewDate = new Date(r, h, F(r, h, o))),
                this.renderYears();
              break;
            case "year prev":
            case "year next":
              (r = "year prev" === n ? r - 1 : r + 1),
                (this.viewDate = new Date(r, h, F(r, h, o))),
                this.renderMonths();
              break;
            case "year current":
            ...
            case "year":
              (r = parseInt(t.text(), 10)),
                (this.date = new Date(r, h, F(r, h, o))),
                s.hasMonth
                  ? ((this.viewDate = new Date(this.date)), this.showView(y))
                  : (t
                      .addClass(i.pickedClass)
                      .siblings()
                      .removeClass(i.pickedClass),
            ...
            case "month picked":
              ...
              break;
            case "month":
              (h = D.inArray(t.text(), i.monthsShort)),
                (this.date = new Date(r, h, F(r, h, o))),
                s.hasDay
                  ? ((this.viewDate = new Date(r, h, F(r, h, o))),
                    this.showView(g))
            ...
            case "day next":
            case "day":
              "day prev" === n ? (h -= 1) : "day next" === n && (h += 1),
                (o = parseInt(t.text(), 10)),
                (this.date = new Date(r, h, o)),
                (this.viewDate = new Date(r, h, o)),
                this.renderDays(),
                "day" === n && this.hideView(),
                this.pick("day");
              break;
      ...
      globalClick: function (e) {
        for (
          var t = e.target, i = this.element, a = this.$trigger[0], s = !0;
          t !== document;
    ...
    T = {
      ...
      renderYears: function () {
        ...
        for (e = -5; e <= 6; e += 1) {
          var p = new Date(h + e, 1, 1),
            f = !1;
          i && ((f = p.getFullYear() < i.getFullYear()), -5 === e && (c = f)),
            !f &&
              a &&
              ((f = p.getFullYear() > a.getFullYear()), 6 === e && (u = f)),
        ...
        this.$yearsPrev.toggleClass(s, c),
      ...
      renderMonths: function () {
        ...
        for (e = 0; e <= 11; e += 1) {
          ...
          i &&
            (m =
              (g = v.getFullYear() === i.getFullYear()) &&
              v.getMonth() < i.getMonth()),
            !m &&
              a &&
              (m =
                (y = v.getFullYear() === a.getFullYear()) &&
                v.getMonth() > a.getMonth()),
            !m && h && (m = !1 === h.call(this.$element, v, "month"));
          var w = o === u && e === p,
        ...
        this.$yearPrev.toggleClass(n, g),
          ...
          this.$yearCurrent.toggleClass(n, g && y).html(o + t.yearSuffix || ""),
      ...
      renderDays: function () {
        ...
        for (
          ...
          var V = new Date($, x, t),
            Y = !1;
          n && (Y = V.getTime() < n.getTime()),
            !Y && d && (Y = !1 === d.call(a, V, "day")),
            C.push(
              this.createItem({
                disabled: Y,
        ...
        this.$monthPrev.toggleClass(l, F),
          ...
          this.$monthCurrent
            ...
            .html(
              s.yearFirst
                ? "".concat(f + p, " ").concat(c[g])
                : "".concat(c[g], " ").concat(f).concat(p)
            ),
          this.$days.html(C.join("") + O.join("") + I.join(""));
      },
    },
    S = "".concat(d, "-top-left"),
          ...
          (this.$scrollParent = (function (e) {
            var t =
              ...
              r = i
                ...
                .eq(0);
            return "fixed" !== a && r.length
              ? r
              : D(e.ownerDocument || document);
          })(e, !0)),
          (this.built = !1),
          (this.shown = !1),
          (this.isInput = !1),
        ...
        (t = [
          {
            ...
            value: function () {
              var e = this.$element,
                ...
                a = t.endDate,
                s = t.date;
              (this.$trigger = D(t.trigger)),
                (this.isInput = e.is("input") || e.is("textarea")),
                (this.inline = t.inline && (t.container || !this.isInput)),
            ...
            value: function () {
              if (!this.built) {
                ...
                (this.$picker = i),
                  ...
                  this.inline
                    ? D(t.container || e).append(
                        i.addClass("".concat(d, "-inline"))
                      )
                    : (D(document.body).append(
                        i.addClass("".concat(d, "-dropdown"))
                      ),
                      i.addClass(p).css({ zIndex: parseInt(t.zIndex, 10) })),
                  this.renderWeek();
              }
            },
          },
          ...
          },
          {
            ...
            value: function () {
              var e = this.options,
                t = this.$element;
              D.isFunction(e.show) && t.on(u, e.show),
                D.isFunction(e.hide) && t.on(o, e.hide),
                D.isFunction(e.pick) && t.on(c, e.pick),
                this.isInput && t.on(l, D.proxy(this.keyup, this)),
                this.inline ||
                  (e.trigger
                    ? this.$trigger.on(r, D.proxy(this.toggle, this))
                    : this.isInput
                    ? t.on(h, D.proxy(this.show, this))
                    : t.on(r, D.proxy(this.show, this)));
            },
          },
          {
            key: "unbind",
            value: function () {
              var e = this.$element,
                t = this.options;
              D.isFunction(t.show) && e.off(u, t.show),
                D.isFunction(t.hide) && e.off(o, t.hide),
                D.isFunction(t.pick) && e.off(c, t.pick),
                this.isInput && e.off(l, this.keyup),
                this.inline ||
                  (t.trigger
                ...
                switch (Number(e)) {
                  case v:
                    i.addClass(p),
                      a.addClass(p),
                      s.hasYear
                        ? (this.renderYears(), t.removeClass(p), this.place())
                        : this.showView(g);
                    break;
                  case y:
                    t.addClass(p),
                  ...
                  default:
                    t.addClass(p),
                      i.addClass(p),
                      s.hasDay
                        ? (this.renderDays(), a.removeClass(p), this.place())
                        : this.showView(y);
                }
            },
          },
              ...
              if (!this.inline) {
                ...
                w(u) && (u = 10),
                  o < c && s < c + r + o
                    ? ((c -= o + u), (p = N))
                    : (c += r + u),
                  a < d + h && ((d += n - h), (p = p.replace("left", "right"))),
                  i.removeClass(q).addClass(p).css({ top: c, left: d });
              }
            },
          },
          {
          ...
          },
          {
            ...
            value: function (e) {
              ...
              return (
                D.extend(a, e),
                a.muted && s.push(t.mutedClass),
                a.highlighted && s.push(t.highlightedClass),
                a.picked && s.push(t.pickedClass),
                a.disabled && s.push(t.disabledClass),
                "<"
                  .concat(i, ' class="')
  ...
  if ((D.extend && D.extend(A.prototype, T, I, Y), D.fn)) {
    ...
    (D.fn.datepicker = function (h) {
      ...
      (D.fn.datepicker.languages = f),
      (D.fn.datepicker.setDefaults = A.setDefaults),
