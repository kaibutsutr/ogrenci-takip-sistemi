(function ($) {
  ...
  /* ---- open proper index page based on monitor size ---- */
  if (
    document.location.pathname == '/index.html' ||
    document.location.pathname == '/'
  ) {
    if ($('.mobile-nav__toggler').css('display') == 'none') {
  ...
  $('#order')
    ...
    .change(function () {
      ...
      if ($(this).val() == '2') {
        $('#order option[value=2]').attr('selected', true);
        sortVillasByPopularity();
      }
      if ($(this).val() == '3') {
        $('#order option[value=3]').attr('selected', true);
        sortVillasByPriceAsc();
      }
      if ($(this).val() == '4') {
        $('#order option[value=4]').attr('selected', true);
        sortVillasByPriceDesc();
      }
    });
})(jQuery);
        ...
        $("<a>")
          ...
          .append(
            $("<div>")
              ...
              .append(
                $("<img>").attr({
                  src: "https://tasmahal.s3.eu-north-1.amazonaws.com/cards/derbent-villas-21-grid.webp",
                  alt: "",
                })
              )
              .append(
        ...
        $("<a>")
          ...
          .append(
            $("<div>")
              ...
              .append(
                $("<img>").attr({
                  src: "https://tasmahal.s3.eu-north-1.amazonaws.com/cards/Stone_house_card.webp",
                  alt: "",
                })
              )
              .append(
...
function sortVillasByPopularity() {
  $("#villas-grid").empty();
  $("#villas-grid-2").empty();
  $("#villas-grid-3").empty();
  $("#villas-grid-4").empty();
